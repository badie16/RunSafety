...
impl AnalyticsDashboard {
    ...
    pub async fn record_session_start(&self, session_id: u64, pid: u32, cli_type: &CliType) -> Result<()> {
        ...
        conn.execute(
            ...
            params![session_id, pid, cli_type.to_string(), chrono_now()],
        )?;
        Ok(())
    }
    ...
    pub async fn record_session_end(&self, session_id: u64, peak_memory: u64) -> Result<()> {
        ...
        conn.execute(
            ...
            params![chrono_now(), peak_memory, session_id],
        )?;
        Ok(())
    }
    ...
    pub async fn record_event(
        ...
        conn.execute(
            ...
            params![chrono_now(), session_id, event_type, severity.to_string(), details],
        )?;
        Ok(())
    }
    ...
    pub async fn record_memory_usage(&self, session_id: u64, rss_bytes: u64) -> Result<()> {
        ...
        conn.execute(
            ...
            params![chrono_now(), session_id, rss_bytes],
        )?;
        Ok(())
    }
